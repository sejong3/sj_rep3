...
>>> print my_file.readline()
0331_103255.9951=End to (Off)

>>> print my_flie.readline()

Traceback (most recent call last):
  File "<pyshell#18>", line 1, in <module>
    print my_flie.readline()
NameError: name 'my_flie' is not defined
>>> print my_file.readline()
0403_091758.2830=End to (None)

>>> print my_file.readline()
0403_102726.0753=End to (None)

>>> my_file.seek(0)
>>> print my_file.readlines()
['[Done]\n', '0331_103255.9951=End to (Off)\n', '0403_091758.2830=End to (None)\n', '0403_102726.0753=End to (None)\n', '0403_162617.8814=End to (None)\n', '0404_132102.2028=End to (None)\n', '[LastLog]\n', 'Action=None\n', 'Key=0404_132107.6923\n', '[None]\n', '0403_091758.2841=Begin from (Done)\n', '0403_091803.8280=End to (Off)\n', '0403_102726.0763=Begin from (Done)\n', '0403_102731.6535=End to (Off)\n', '0403_162617.8824=Begin from (Done)\n', '0403_162623.5241=End to (Off)\n', '0404_132102.2038=Begin from (Done)\n', '0404_132107.6923=End to (Off)\n']
>>> 
